...
const products = [
    {id:1, price: 2400, off: 2100, percent: -12 ,name: 'کافه 1', image: coffee4 },
    {id:2, price: 2400, off: 2100, percent: -12 ,name: 'کافه 2', image: coffee2 },
    {id:3, price: 2400, off: 2100, percent: -12 ,name: 'کافه 3', image: coffee3 },
    {id:4, price: 2400, off: 2100, percent: -12 ,name: 'کافه 4', image: coffee1 },
]
const SliderOne = () => {
    return (
        <>
      ...
      className="SliderOne w-[90%]">
        {
          products.map(product => (
            <SwiperSlide key={product.id} className='relative p-5 group bg-white shadow-md rounded-md overflow-hidden lg:p-0'>
                <Product 
                    name={product.name}
                    price={product.price}
                    off={product.off}
