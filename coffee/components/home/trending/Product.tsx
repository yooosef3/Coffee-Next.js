...
const Product = ({percent, off, image, name, price, hover}:ProductPropsType) => {
    return (
        <div className="p-5 md:w-[280px] group">
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-1 lg:hidden lg:group-hover:flex lg:absolute bottom-[35%] lg:justify-center">
                    <Link href='/'>
