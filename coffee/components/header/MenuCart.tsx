...
const MenuCart = ({toggle}:PropTypes) => {
    return (
        <div className={`absolute bg-white ${toggle? 'flex flex-col' : 'hidden'}  gap-4 rounded-lg p-5`}>
            ...
            <div className="flex flex-col gap-3">
                <Link className="text-white font-bold text-center py-2 bg-zinc-800 rounded-sm hover:bg-emerald-600 duration-200" href='/'>مشاهده سبد خرید</Link>
                <Link className="text-white font-bold text-center py-2 bg-zinc-800 rounded-sm hover:bg-emerald-600 duration-200" href='/'>تسویه</Link>
            </div>
        </div>
    );
};
